...
<p class="text-center"> Why to use Jekyll and GitPages </p>

<p class="text-center"> Why this tutorial?</p>

### Ok, let's start. What do we need?

<p class="text-center"> Requirements and structure </p>

### Start playing around with the files. Initial configuration

<p class="text-center"> First steps</p>
